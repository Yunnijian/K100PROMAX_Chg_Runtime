...
#define INTEL_I810_IDS(MACRO__, ...) \
	MACRO__(0x7121, ## __VA_ARGS__),  \
	MACRO__(0x7123, ## __VA_ARGS__),  \
	MACRO__(0x7125, ## __VA_ARGS__)  

#define INTEL_I815_IDS(MACRO__, ...) \
	MACRO__(0x1132, ## __VA_ARGS__)  
...
#define INTEL_I85X_IDS(MACRO__, ...) \
	MACRO__(0x3582, ## __VA_ARGS__),  \
	MACRO__(0x358e, ## __VA_ARGS__)

#define INTEL_I865G_IDS(MACRO__, ...) \
	MACRO__(0x2572, ## __VA_ARGS__) 

#define INTEL_I915G_IDS(MACRO__, ...) \
	MACRO__(0x2582, ## __VA_ARGS__),  \
	MACRO__(0x258a, ## __VA_ARGS__)  

#define INTEL_I915GM_IDS(MACRO__, ...) \
	MACRO__(0x2592, ## __VA_ARGS__) 

#define INTEL_I945G_IDS(MACRO__, ...) \
	MACRO__(0x2772, ## __VA_ARGS__) 

#define INTEL_I945GM_IDS(MACRO__, ...) \
	MACRO__(0x27a2, ## __VA_ARGS__),  \
	MACRO__(0x27ae, ## __VA_ARGS__)  

#define INTEL_I965G_IDS(MACRO__, ...) \
	MACRO__(0x2972, ## __VA_ARGS__),  \
	MACRO__(0x2982, ## __VA_ARGS__),	 \
	MACRO__(0x2992, ## __VA_ARGS__),	 \
	MACRO__(0x29a2, ## __VA_ARGS__)	

#define INTEL_G33_IDS(MACRO__, ...) \
	MACRO__(0x29b2, ## __VA_ARGS__),  \
	MACRO__(0x29c2, ## __VA_ARGS__),	 \
	MACRO__(0x29d2, ## __VA_ARGS__)	

#define INTEL_I965GM_IDS(MACRO__, ...) \
	MACRO__(0x2a02, ## __VA_ARGS__),	 \
	MACRO__(0x2a12, ## __VA_ARGS__)  

#define INTEL_GM45_IDS(MACRO__, ...) \
	MACRO__(0x2a42, ## __VA_ARGS__) 

#define INTEL_G45_IDS(MACRO__, ...) \
	MACRO__(0x2e02, ## __VA_ARGS__),  \
	MACRO__(0x2e12, ## __VA_ARGS__),  \
	MACRO__(0x2e22, ## __VA_ARGS__),  \
	MACRO__(0x2e32, ## __VA_ARGS__),  \
	MACRO__(0x2e42, ## __VA_ARGS__),  \
	MACRO__(0x2e92, ## __VA_ARGS__)	
...
#define INTEL_IVB_M_GT1_IDS(MACRO__, ...) \
	MACRO__(0x0156, ## __VA_ARGS__) 

#define INTEL_IVB_M_GT2_IDS(MACRO__, ...) \
	MACRO__(0x0166, ## __VA_ARGS__) 
...
#define INTEL_IVB_D_GT1_IDS(MACRO__, ...) \
	MACRO__(0x0152, ## __VA_ARGS__),  \
	MACRO__(0x015a, ## __VA_ARGS__)  

#define INTEL_IVB_D_GT2_IDS(MACRO__, ...) \
	MACRO__(0x0162, ## __VA_ARGS__),  \
	MACRO__(0x016a, ## __VA_ARGS__)  
...
#define INTEL_IVB_Q_IDS(MACRO__, ...) \
	INTEL_QUANTA_VGA_DEVICE(__VA_ARGS__) 

#define INTEL_HSW_ULT_GT1_IDS(MACRO__, ...) \
	MACRO__(0x0A02, ## __VA_ARGS__),  \
	MACRO__(0x0A06, ## __VA_ARGS__),  \
	MACRO__(0x0A0A, ## __VA_ARGS__),  \
	MACRO__(0x0A0B, ## __VA_ARGS__)  

#define INTEL_HSW_ULX_GT1_IDS(MACRO__, ...) \
	MACRO__(0x0A0E, ## __VA_ARGS__) 

#define INTEL_HSW_GT1_IDS(MACRO__, ...) \
	INTEL_HSW_ULT_GT1_IDS(MACRO__, ## __VA_ARGS__), \
	INTEL_HSW_ULX_GT1_IDS(MACRO__, ## __VA_ARGS__), \
	MACRO__(0x0402, ## __VA_ARGS__),  \
	MACRO__(0x0406, ## __VA_ARGS__),  \
	MACRO__(0x040A, ## __VA_ARGS__),  \
	MACRO__(0x040B, ## __VA_ARGS__),  \
	MACRO__(0x040E, ## __VA_ARGS__),  \
	MACRO__(0x0C02, ## __VA_ARGS__),  \
	MACRO__(0x0C06, ## __VA_ARGS__),  \
	MACRO__(0x0C0A, ## __VA_ARGS__),  \
	MACRO__(0x0C0B, ## __VA_ARGS__),  \
	MACRO__(0x0C0E, ## __VA_ARGS__),  \
	MACRO__(0x0D02, ## __VA_ARGS__),  \
	MACRO__(0x0D06, ## __VA_ARGS__),  \
	MACRO__(0x0D0A, ## __VA_ARGS__),  \
	MACRO__(0x0D0B, ## __VA_ARGS__),  \
	MACRO__(0x0D0E, ## __VA_ARGS__)  

#define INTEL_HSW_ULT_GT2_IDS(MACRO__, ...) \
	MACRO__(0x0A12, ## __VA_ARGS__),  \
	MACRO__(0x0A16, ## __VA_ARGS__),  \
	MACRO__(0x0A1A, ## __VA_ARGS__),  \
	MACRO__(0x0A1B, ## __VA_ARGS__)   \

#define INTEL_HSW_ULX_GT2_IDS(MACRO__, ...) \
	MACRO__(0x0A1E, ## __VA_ARGS__)  \

#define INTEL_HSW_GT2_IDS(MACRO__, ...) \
	INTEL_HSW_ULT_GT2_IDS(MACRO__, ## __VA_ARGS__), \
	INTEL_HSW_ULX_GT2_IDS(MACRO__, ## __VA_ARGS__), \
	MACRO__(0x0412, ## __VA_ARGS__),  \
	MACRO__(0x0416, ## __VA_ARGS__),  \
	MACRO__(0x041A, ## __VA_ARGS__),  \
	MACRO__(0x041B, ## __VA_ARGS__),  \
	MACRO__(0x041E, ## __VA_ARGS__),  \
	MACRO__(0x0C12, ## __VA_ARGS__),  \
	MACRO__(0x0C16, ## __VA_ARGS__),  \
	MACRO__(0x0C1A, ## __VA_ARGS__),  \
	MACRO__(0x0C1B, ## __VA_ARGS__),  \
	MACRO__(0x0C1E, ## __VA_ARGS__),  \
	MACRO__(0x0D12, ## __VA_ARGS__),  \
	MACRO__(0x0D16, ## __VA_ARGS__),  \
	MACRO__(0x0D1A, ## __VA_ARGS__),  \
	MACRO__(0x0D1B, ## __VA_ARGS__),  \
	MACRO__(0x0D1E, ## __VA_ARGS__)  

#define INTEL_HSW_ULT_GT3_IDS(MACRO__, ...) \
	MACRO__(0x0A22, ## __VA_ARGS__),  \
	MACRO__(0x0A26, ## __VA_ARGS__),  \
	MACRO__(0x0A2A, ## __VA_ARGS__),  \
	MACRO__(0x0A2B, ## __VA_ARGS__),  \
	MACRO__(0x0A2E, ## __VA_ARGS__)  

#define INTEL_HSW_GT3_IDS(MACRO__, ...) \
	INTEL_HSW_ULT_GT3_IDS(MACRO__, ## __VA_ARGS__), \
	MACRO__(0x0422, ## __VA_ARGS__),  \
	MACRO__(0x0426, ## __VA_ARGS__),  \
	MACRO__(0x042A, ## __VA_ARGS__),  \
	MACRO__(0x042B, ## __VA_ARGS__),  \
	MACRO__(0x042E, ## __VA_ARGS__),  \
	MACRO__(0x0C22, ## __VA_ARGS__),  \
	MACRO__(0x0C26, ## __VA_ARGS__),  \
	MACRO__(0x0C2A, ## __VA_ARGS__),  \
	MACRO__(0x0C2B, ## __VA_ARGS__),  \
	MACRO__(0x0C2E, ## __VA_ARGS__),  \
	MACRO__(0x0D22, ## __VA_ARGS__),  \
	MACRO__(0x0D26, ## __VA_ARGS__),  \
	MACRO__(0x0D2A, ## __VA_ARGS__),  \
	MACRO__(0x0D2B, ## __VA_ARGS__),  \
	MACRO__(0x0D2E, ## __VA_ARGS__)  
...
#define INTEL_SKL_ULT_GT1_IDS(MACRO__, ...) \
	MACRO__(0x1906, ## __VA_ARGS__),  \
	MACRO__(0x1913, ## __VA_ARGS__)  

#define INTEL_SKL_ULX_GT1_IDS(MACRO__, ...) \
	MACRO__(0x190E, ## __VA_ARGS__),  \
	MACRO__(0x1915, ## __VA_ARGS__)  

#define INTEL_SKL_GT1_IDS(MACRO__, ...) \
	INTEL_SKL_ULT_GT1_IDS(MACRO__, ## __VA_ARGS__), \
	INTEL_SKL_ULX_GT1_IDS(MACRO__, ## __VA_ARGS__), \
	MACRO__(0x1902, ## __VA_ARGS__),  \
	MACRO__(0x190A, ## __VA_ARGS__),  \
	MACRO__(0x190B, ## __VA_ARGS__),  \
	MACRO__(0x1917, ## __VA_ARGS__)  

#define INTEL_SKL_ULT_GT2_IDS(MACRO__, ...) \
	MACRO__(0x1916, ## __VA_ARGS__),  \
	MACRO__(0x1921, ## __VA_ARGS__)  

#define INTEL_SKL_ULX_GT2_IDS(MACRO__, ...) \
	MACRO__(0x191E, ## __VA_ARGS__) 

#define INTEL_SKL_GT2_IDS(MACRO__, ...) \
	INTEL_SKL_ULT_GT2_IDS(MACRO__, ## __VA_ARGS__), \
	INTEL_SKL_ULX_GT2_IDS(MACRO__, ## __VA_ARGS__), \
	MACRO__(0x1912, ## __VA_ARGS__),  \
	MACRO__(0x191A, ## __VA_ARGS__),  \
	MACRO__(0x191B, ## __VA_ARGS__),  \
	MACRO__(0x191D, ## __VA_ARGS__)  

#define INTEL_SKL_ULT_GT3_IDS(MACRO__, ...) \
	MACRO__(0x1923, ## __VA_ARGS__),  \
	MACRO__(0x1926, ## __VA_ARGS__),  \
	MACRO__(0x1927, ## __VA_ARGS__)  

#define INTEL_SKL_GT3_IDS(MACRO__, ...) \
	INTEL_SKL_ULT_GT3_IDS(MACRO__, ## __VA_ARGS__), \
	MACRO__(0x192A, ## __VA_ARGS__),  \
	MACRO__(0x192B, ## __VA_ARGS__),  \
	MACRO__(0x192D, ## __VA_ARGS__)  

#define INTEL_SKL_GT4_IDS(MACRO__, ...) \
	MACRO__(0x1932, ## __VA_ARGS__),  \
	MACRO__(0x193A, ## __VA_ARGS__),  \
	MACRO__(0x193B, ## __VA_ARGS__),  \
	MACRO__(0x193D, ## __VA_ARGS__) 
...
#define INTEL_BXT_IDS(MACRO__, ...) \
	...
	MACRO__(0x5A84, ## __VA_ARGS__),  \
	MACRO__(0x5A85, ## __VA_ARGS__)  
...
#define INTEL_KBL_ULT_GT1_IDS(MACRO__, ...) \
	MACRO__(0x5906, ## __VA_ARGS__),  \
	MACRO__(0x5913, ## __VA_ARGS__)  

#define INTEL_KBL_ULX_GT1_IDS(MACRO__, ...) \
	MACRO__(0x590E, ## __VA_ARGS__),  \
	MACRO__(0x5915, ## __VA_ARGS__)  
...
#define INTEL_KBL_GT1_IDS(MACRO__, ...) \
	...
	MACRO__(0x5908, ## __VA_ARGS__),  \
	MACRO__(0x590A, ## __VA_ARGS__),  \
	MACRO__(0x590B, ## __VA_ARGS__) 

#define INTEL_KBL_ULT_GT2_IDS(MACRO__, ...) \
	MACRO__(0x5916, ## __VA_ARGS__),  \
	MACRO__(0x5921, ## __VA_ARGS__)  

#define INTEL_KBL_ULX_GT2_IDS(MACRO__, ...) \
	MACRO__(0x591E, ## __VA_ARGS__)  

#define INTEL_KBL_GT2_IDS(MACRO__, ...) \
	INTEL_KBL_ULT_GT2_IDS(MACRO__, ## __VA_ARGS__), \
	INTEL_KBL_ULX_GT2_IDS(MACRO__, ## __VA_ARGS__), \
	MACRO__(0x5912, ## __VA_ARGS__),  \
	MACRO__(0x5917, ## __VA_ARGS__),  \
	MACRO__(0x591A, ## __VA_ARGS__),  \
	MACRO__(0x591B, ## __VA_ARGS__),  \
	MACRO__(0x591D, ## __VA_ARGS__) 

#define INTEL_KBL_ULT_GT3_IDS(MACRO__, ...) \
	MACRO__(0x5926, ## __VA_ARGS__) 

#define INTEL_KBL_GT3_IDS(MACRO__, ...) \
	INTEL_KBL_ULT_GT3_IDS(MACRO__, ## __VA_ARGS__), \
	MACRO__(0x5923, ## __VA_ARGS__),  \
	MACRO__(0x5927, ## __VA_ARGS__) 

#define INTEL_KBL_GT4_IDS(MACRO__, ...) \
	MACRO__(0x593B, ## __VA_ARGS__) 


#define INTEL_AML_KBL_GT2_IDS(MACRO__, ...) \
	MACRO__(0x591C, ## __VA_ARGS__),   \
	MACRO__(0x87C0, ## __VA_ARGS__) 
...
#define INTEL_CFL_S_GT1_IDS(MACRO__, ...) \
	MACRO__(0x3E90, ## __VA_ARGS__),  \
	MACRO__(0x3E93, ## __VA_ARGS__),  \
	MACRO__(0x3E99, ## __VA_ARGS__)  

#define INTEL_CFL_S_GT2_IDS(MACRO__, ...) \
	MACRO__(0x3E91, ## __VA_ARGS__),  \
	MACRO__(0x3E92, ## __VA_ARGS__),  \
	MACRO__(0x3E96, ## __VA_ARGS__),  \
	MACRO__(0x3E98, ## __VA_ARGS__),  \
	MACRO__(0x3E9A, ## __VA_ARGS__)  
...
#define INTEL_CFL_H_GT2_IDS(MACRO__, ...) \
	MACRO__(0x3E94, ## __VA_ARGS__),   \
	MACRO__(0x3E9B, ## __VA_ARGS__) 
...
#define INTEL_CFL_U_GT3_IDS(MACRO__, ...) \
	MACRO__(0x3EA5, ## __VA_ARGS__),  \
	MACRO__(0x3EA6, ## __VA_ARGS__),  \
	MACRO__(0x3EA7, ## __VA_ARGS__),  \
	MACRO__(0x3EA8, ## __VA_ARGS__)  
