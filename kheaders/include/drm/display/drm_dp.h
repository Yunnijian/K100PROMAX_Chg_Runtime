...
# define DP_ALPM_PM_STATE_2A_SUPPORT	    (1 << 1) 
# define DP_ALPM_AUX_LESS_CAP		    (1 << 2) 
...
# define DP_ALPM_MODE_AUX_LESS		    (1 << 2) 
...
# define DP_PSR_ENABLE_SU_REGION_ET             BIT(7) 
...
#define DP_PANEL_REPLAY_ERROR_STATUS                   0x2020  
...
#define DP_OUI_PHY_REPEATER1				    0xf003d 
...
#define DP_SDP_ADAPTIVE_SYNC		0x22 
