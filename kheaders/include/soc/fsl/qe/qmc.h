...
#define QMC_RX_FLAG_HDLC_LAST	BIT(11) 
#define QMC_RX_FLAG_HDLC_FIRST	BIT(10) 
#define QMC_RX_FLAG_HDLC_OVF	BIT(5)  
#define QMC_RX_FLAG_HDLC_UNA	BIT(4)  
#define QMC_RX_FLAG_HDLC_ABORT	BIT(3)  
