...
TRACE_EVENT(sched_pe_enqueue_sleeping_task,
	...
	TP_fast_assign(
		...
		__entry->owner_prio	= mutex_owner->prio; 
		...
		__entry->blocked_prio	= blocked->prio; 
...
TRACE_EVENT(sched_pe_owner_is_migrating,
	...
	TP_fast_assign(
		...
		__entry->waiter_prio	= waiter->prio; 
	),
