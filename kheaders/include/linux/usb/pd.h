...
#define SINK_MODE_BATT_UL	BIT(4) 
...
#define PDO_EPR_AVS_APDO_MAX_VOLT	GENMASK(25, 17)	
#define PDO_EPR_AVS_APDO_MIN_VOLT	GENMASK(15, 8)	
#define PDO_EPR_AVS_APDO_PDP		GENMASK(7, 0) 


#define PDO_SPR_AVS_APDO_PEAK_CURRENT		GENMASK(27, 26)


#define PDO_SPR_AVS_APDO_9V_TO_15V_MAX_CURR	GENMASK(19, 10)	
#define PDO_SPR_AVS_APDO_15V_TO_20V_MAX_CURR	GENMASK(9, 0)	
