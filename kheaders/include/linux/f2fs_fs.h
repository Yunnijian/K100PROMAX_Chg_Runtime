...
#define F2FS_MAX_LOG_SECTOR_SIZE	PAGE_SHIFT	
#define F2FS_LOG_SECTORS_PER_BLOCK	(PAGE_SHIFT - 9) 
#define F2FS_BLKSIZE			PAGE_SIZE 
#define F2FS_BLKSIZE_BITS		PAGE_SHIFT 
