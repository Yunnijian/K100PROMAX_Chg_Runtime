...
enum omnia_commands_e {
	OMNIA_CMD_GET_STATUS_WORD		= 0x01, 
	OMNIA_CMD_GENERAL_CONTROL		= 0x02,
	OMNIA_CMD_LED_MODE			= 0x03, 
	OMNIA_CMD_LED_STATE			= 0x04, 
	OMNIA_CMD_LED_COLOR			= 0x05, 
	OMNIA_CMD_USER_VOLTAGE			= 0x06,
	OMNIA_CMD_SET_BRIGHTNESS		= 0x07,
	OMNIA_CMD_GET_BRIGHTNESS		= 0x08,
	OMNIA_CMD_GET_RESET			= 0x09,
	OMNIA_CMD_GET_FW_VERSION_APP		= 0x0A, 
	OMNIA_CMD_SET_WATCHDOG_STATE		= 0x0B, 

	

	OMNIA_CMD_GET_WATCHDOG_STATE		= 0x0D,
	OMNIA_CMD_GET_FW_VERSION_BOOT		= 0x0E, 
	OMNIA_CMD_GET_FW_CHECKSUM		= 0x0F, 
