...
#define TLBI_Op1_EL1	0	
#define TLBI_Op1_EL2	4	

#define TLBI_CRn_XS	8	
#define TLBI_CRn_nXS	9	

#define TLBI_CRm_IPAIS	0	
#define TLBI_CRm_nROS	1	
#define TLBI_CRm_RIS	2	
#define TLBI_CRm_nRIS	3	
#define TLBI_CRm_IPAONS	4	
#define TLBI_CRm_ROS	5	
#define TLBI_CRm_RNS	6	
#define TLBI_CRm_nRNS	7	
